...
- Use Cases ficam em `domain/src/application/`, recebem repositórios por injeção (higher-order function) e implementam a orquestração da lógica de negócio, chamando as entidades e repositórios conforme necessário.
- Contratos de interfaces de repositório + DTOs ficam em `domain/src/contracts/`, que a infraestrutura implementa.
